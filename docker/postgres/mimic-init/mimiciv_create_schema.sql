-- MIMIC-IV PostgreSQL schema bootstrap (based on MIT-LCP/mimic-code build scripts)
-- Schemas only: hosp, icu, derived placeholder
-- Source reference:
-- https://raw.githubusercontent.com/MIT-LCP/mimic-code/main/mimic-iv/buildmimic/postgres/create.sql
...
-- Optional helper: basic search_path for sessions
-- SET search_path TO mimiciv_hosp, mimiciv_icu, mimiciv_derived, public;
